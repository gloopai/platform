...
CREATE TABLE IF NOT EXISTS channels (
  ...
  upstream_payin_rate_bps INT NOT NULL DEFAULT 0 COMMENT '代收上游成本比例：万分比整数(=round(百分数×100))',
  upstream_payout_rate_bps INT NOT NULL DEFAULT 0 COMMENT '代付上游成本比例：同上',
  upstream_payout_fee_mode TINYINT NOT NULL DEFAULT 1 COMMENT '代付上游计费模式：1=仅比例 2=仅固定 3=固定+比例',
