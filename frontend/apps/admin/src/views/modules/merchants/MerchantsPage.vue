  ...
  <div class="grid gap-4">
    ...
    <div class="grid grid-cols-12 gap-4">
      ...
      <div class="col-span-12 md:col-span-8">
        ...
        >
          <div class="flex border-b border-slate-200 px-4 pt-3" role="tablist" aria-label="商户详情">
            <button
              type="button"
              role="tab"
              :aria-selected="rightTab === 'basic'"
              class="relative -mb-px border-b-2 px-4 pb-3 text-sm font-semibold transition"
              :class="
                rightTab === 'basic'
                  ? 'border-slate-900 text-slate-900'
                  : 'border-transparent text-slate-500 hover:text-slate-800'
              "
              @click="rightTab = 'basic'"
            >
              基本信息
            </button>
            <button
              type="button"
              role="tab"
              :aria-selected="rightTab === 'bindings'"
              class="relative -mb-px border-b-2 px-4 pb-3 text-sm font-semibold transition"
              :class="
                rightTab === 'bindings'
                  ? 'border-slate-900 text-slate-900'
          ...
          <div v-show="rightTab === 'bindings'" role="tabpanel">
...
const rightTab = ref<'basic' | 'bindings'>('basic')
