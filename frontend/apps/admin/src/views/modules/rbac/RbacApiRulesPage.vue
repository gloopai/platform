  ...
  <div class="space-y-4">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      <div class="flex flex-wrap items-center justify-between gap-2">
        <div>
          <div class="text-sm font-semibold text-slate-900">接口规则汇总</div>
          <p class="mt-0.5 text-xs text-slate-500">与菜单管理共用同一数据；这里用于集中维护 method + path_pattern 到 perm_key 的映射。</p>
        </div>
        <button
          type="button"
